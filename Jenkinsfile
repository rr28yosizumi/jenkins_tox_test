    ...
    stages {
        stage('Test') {
            steps {
                ...
                sh '/root/.pyenv/bin/pyenv init -'
                sh '/root/.pyenv/bin/pyenv install 3.5.9'
                sh '/root/.pyenv/bin/pyenv install 3.6.2'
                sh '/root/.pyenv/bin/pyenv install 3.7.2'
                sh '/root/.pyenv/bin/pyenv install 3.8.2'
                sh 'python -V'
